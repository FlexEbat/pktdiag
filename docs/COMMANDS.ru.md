...
Открывает интерактивный терминальный просмотр одного отчёта: вкладки
Overview, TCP, DNS и Anomalies. Переключение вкладок стрелками, Tab или
цифрами от 1 до 4. Выход по `q`, `Esc` или `Ctrl+C`.
